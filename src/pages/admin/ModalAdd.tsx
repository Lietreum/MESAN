...
const AccountModal: React.FC<AccountModalProps> = ({ account, onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-[rgba(0,0,0,0.5)] overflow-auto">
      <div className="bg-white text-gray-900 w-full max-w-lg md:max-w-2xl rounded-lg shadow-lg transition-transform duration-300 transform">
        <div className="flex">
          {/* Sidebar */}
          ...
          <div className="w-3/4 p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                onClick={onClose}
                className="text-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 rounded-md transition-colors duration-200"
              >
                {/* Close Button Icon */}
              </button>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex justify-end mt-8">
                <button
                  className="bg-gradient-to-r from-green-500 to-teal-500 px-4 py-2 rounded-lg text-white shadow-lg transition-all duration-300"
                  onClick={handleSave}
                >
                  Save
                </button>
