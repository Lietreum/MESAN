...
const PaymentWaitingPage: React.FC = () => {
  ...
  const handleContinuePayment = () => {
    // Arahkan ke halaman yang sesuai, di sini bisa disesuaikan
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      {/* Bagian Countdown */}
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg text-center border border-gray-300">
        ...
        <div className="flex justify-center items-center space-x-4 mb-4">
          <div className="bg-gray-100 text-black rounded-lg py-3 px-6 text-center">
      ...
      <div className="bg-white mt-6 p-4 rounded-lg shadow-md w-full max-w-lg border border-gray-300">
